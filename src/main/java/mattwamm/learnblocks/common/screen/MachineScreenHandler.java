package mattwamm.learnblocks.common.screen;

import mattwamm.learnblocks.util.registries.ScreenHandlers;
...
public class MachineScreenHandler extends ScreenHandler {
    ...
    public MachineScreenHandler(int syncId, PlayerInventory playerInventory, Inventory inventory) {
        super(ScreenHandlers.MACHINE_SCREEN_HANDLER, syncId);
